...
namespace Ryan\LineKit\Repositories;
...
abstract class Repository
{
    ...
    public function paginateLatest($perPage = null, $columns = ['*'], $pageName = 'page', $page = null)
    {
        return $this->model->latest()->paginate($perPage, $columns, $pageName, $page);
    }

    public function paginateOldest($perPage = null, $columns = ['*'], $pageName = 'page', $page = null)
    {
        return $this->model->oldest()->paginate($perPage, $columns, $pageName, $page);
    }
